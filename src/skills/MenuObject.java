...
public class MenuObject extends JPanel implements ActionListener {
        ...
        if (e.getSource() == select) {
            switch (type) {
                case 0:
                    ...
                    MapArea.selectedType = type;
                    break;
                case 1:
                    MapArea.selectedEmitter = emitter;
                    MapArea.selectedType = type;
                    break;
                case 2:
                    MapArea.selectedNpc = npc;
                    MapArea.selectedType = type;
                    break;
                case 3:
                    MapArea.selectedLight = light;
                    MapArea.selectedType = type;
                    break;
            }
        }
    ...
    public void paintComponent(Graphics g) {
        ...
        for(int i=0; i < 5; i++) {
            g.setColor(colors[i]);
            g.drawRoundRect(0 + i, 0 + i, 249 - 2 * i, 99 - 2 * i, 10, 10);
        }
